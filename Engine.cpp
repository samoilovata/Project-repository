...
Engine::Engine() : window(sf::VideoMode(800, 640), "game") {
    ...
    entityManager.spawnObjectEntity(coin1, "/../Assets/coin.png", 600, 400, 129, 609, 40, 40, 450, 2210, 0, 0);
    entityManager.spawnObjectEntity(coin2, "/../Assets/coin.png", 600, 300, 129, 609, 40, 40, 450, 2210, 0, 0);
