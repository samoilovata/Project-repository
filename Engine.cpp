...
Engine::Engine() : window(sf::VideoMode(800, 640), "game") {
    ...
    entityManager.spawnLocation("/../Assets/background_room.png", sf::Vector2f(0, 0), sf::Vector2f(200, 200), 2);
    ...
    entityManager.spawnInteractiveObjectEntity(pond, "/../Assets/pond.png", -1500, 450, 0, 0, 203, 112, L"Пруд", font, 1);
