...
Engine::Engine() : window(sf::VideoMode(800, 640), "game") {
    ...
    flowerbed = std::make_shared<InteractiveObjectEntity>();
    ...
    entityManager.spawnObjectEntity(coin, "/../Assets/sprite-coin.png", 195, 245, 128, 0, 4, 5, L"Собачини", font, 2);
    entityManager.spawnObjectEntity(berry1, "/../Assets/sprite-berry1.png", 130, 160, 128, 0, 4, 6, L"Ягода", font, 1);
    entityManager.spawnObjectEntity(berry2, "/../Assets/sprite-berry2.png", 570, 540, 128, 0, 3, 4, L"Немного гнилая\nягода", font, 2);
    ...
    entityManager.spawnObjectEntity(flower1, "/../Assets/sprite-flower1.png", 690, 240, 128, 0, 6, 9, L"Тюльпан", font, 1);
    entityManager.spawnObjectEntity(flower2, "/../Assets/sprite-flower2.png", 150, 150, 128, 0, 5, 10, L"Оч красиви\nцветочек", font, 1);
    entityManager.spawnObjectEntity(seeds, "/../Assets/sprite-seeds.png", 405, 255, 128, 0, 7, 7, L"Семена", font, 2);
    ...
    entityManager.spawnInteractiveObjectEntity(flowerbed, "/../Assets/flowerbed.png", 610, 260, 0, 0, 38, 18, L"", font, 1);
    entityManager.spawnInteractiveObjectEntity(gardenbed, "/../Assets/gardenbed.png", 500, 500, 0, 0, 57, 28, L"Кажется, здесь можно\nчто-то вырастить", font, 1);
    entityManager.spawnInteractiveObjectEntity(pot, "/../Assets/pot.png", 160, 450, 0, 7, 21, 22, L"Нужно собрать\nвсе ингредиенты", font, 2);
